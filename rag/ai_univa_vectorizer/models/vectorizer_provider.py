...
class AiunivaVectorizerProvider(models.Model):
    _name = "ai_univa.vectorizer.provider"
    _description = "AI univa Vectorizer Provider"
    _order = "id"
    ...
    def upsert_documents(self, *, collection: str, documents: list[Document]): #this function generates advertisements embeddings
        """
        ...
        # add or update documents with the given ids ## this part of the function come from langchain_core.vectorstores and can work with difernt databases
