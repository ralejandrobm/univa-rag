...
class AiunivaAdvertisement(models.Model):
    _name = "ai_univa.advertisement"
    _inherit = [
        "ai_univa.advertisement",
        "ai_univa.vectorizer.mixin",
    ]

    def _get_provider(self):
        provider = "advertisement-pg-vector"
        return self.env["ai_univa.vectorizer.provider"].search(
    ...
    def _get_collection_name(self):
        return "ai_univa_advertisement_vectors"
