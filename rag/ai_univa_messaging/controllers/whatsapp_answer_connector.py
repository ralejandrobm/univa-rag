...
class AiunivaWhatsappAnswerConnectorController(http.Controller):
    @http.route(
    ...
    def get_answers(self, **kwargs):
        ...
        try:
            ...
            _logger.error(f"[❌][AiunivaMessagingController] Error: {e.json()}")
            return Response(
        ...
        answer = (
            http.request.env["ai_univa.answer.generation"]
            .sudo()
            .generate_answer(
